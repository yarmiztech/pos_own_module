odoo.define('pos_network_printer_bankcash.ScreenWidget', function (require) {
    'use strict';
    ...
    var NetPrinter = require('pos_network_printer_bankcash.Printer');
    ...
    const ReceiptScreenInherit = (ReceiptScreen) =>
        class extends ReceiptScreen {
            ...
            async _printNetwork() {
                ...
                var normal_printers= self.env.pos.printers;
//                for (var i = 0; i < normal_printers.length; i++)
//                {
//                     printers.push(normal_printers[i].config)
//                     }
//                printers = normal_printers
               for (var j =0; j < printers.length; j++)
               {
               for (var i = 0; i < normal_printers.length; i++)
                {
                if(printers[j].printer_ip !== normal_printers[i].config.printer_ip){
                     debugger;
                ...
                console.log(receiptString,'receiptString',self)
